...
public class GRAxeItem extends AxeItem implements RoseTools {
    ...
    public boolean canAttackBlock(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer) {
        return !isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_AXE.get()));
    }

    @Override
    public float getAttackDamage() {
        return isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_AXE.get())) ? 0.0F : super.getAttackDamage();
    }
    ...
    public ItemStack getCraftingRemainingItem(ItemStack itemStack) {
        return DesiresTags.AllItemTags.ADDITIONAL_DROPS_TOOL.matches(itemStack) ? new ItemStack(DesiresItems.GILDED_ROSE_AXE.get()) : super.getCraftingRemainingItem(itemStack);
    }
