...
public class FluidReservoirItem extends BlockItem {
    ...
    public FluidReservoirItem(Block p_i48527_1_, Properties p_i48527_2_) {
    ...
    private void tryMultiPlace(BlockPlaceContext ctx) {
        ...
        if (!FluidReservoirBlock.isTank(placedOnState))
            return;
        FluidReservoirBlockEntity tankAt = ConnectivityHandler.partAt(DesiresBlockEntityTypes.FLUID_RESERVOIR.get(), world, placedOnPos);
        if (tankAt == null)
            return;
