...
public class GRPickaxeItem extends PickaxeItem implements RoseTools {
    public GRPickaxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public boolean canAttackBlock(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer) {
        return !isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_PICKAXE.get()));
    }

    @Override
    public float getAttackDamage() {
        return isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_PICKAXE.get())) ? 0.0F : super.getAttackDamage();
    }
    ...
    public ItemStack getCraftingRemainingItem(ItemStack itemStack) {
        return DesiresTags.AllItemTags.ADDITIONAL_DROPS_TOOL.matches(itemStack) ? new ItemStack(DesiresItems.GILDED_ROSE_PICKAXE.get()) : super.getCraftingRemainingItem(itemStack);
    }
