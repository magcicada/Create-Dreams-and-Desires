...
public class GRShovelItem extends ShovelItem implements RoseTools {
    public GRShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public boolean canAttackBlock(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer) {
        return !isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_SHOVEL.get()));
    }

    @Override
    public float getAttackDamage() {
        return isOnCooldown(new ItemStack(DesiresItems.GILDED_ROSE_SHOVEL.get())) ? 0.0F : super.getAttackDamage();
    }
    ...
    public ItemStack getCraftingRemainingItem(ItemStack itemStack) {
        return DesiresTags.AllItemTags.ADDITIONAL_DROPS_TOOL.matches(itemStack) ? new ItemStack(DesiresItems.GILDED_ROSE_SHOVEL.get()) : super.getCraftingRemainingItem(itemStack);
    }
